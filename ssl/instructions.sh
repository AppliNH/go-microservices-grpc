...
# Thanks to https://github.com/simplesteph for this file !
...
openssl x509 -req -passin pass:1111 -days 3650 -in ssl/server.csr -CA ssl/ca.crt -CAkey ssl/ca.key -set_serial 01 -out ssl/server.crt 
